...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET,"/users/username/exists/**").anonymous()
                .antMatchers(HttpMethod.GET,"/users/phoneNumber/exists/**").anonymous()
                .antMatchers(HttpMethod.GET,"/users/email/exists/**").anonymous()
                ...
                .antMatchers(HttpMethod.PUT, "/orders/assignDeliveryGuy/**").hasRole("MANAGER")
